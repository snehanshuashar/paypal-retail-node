...
module.exports = {
    ...
    configure: function configure(environment, options) {
        ...
        if (!options.scopes) {
            options.scopes = 'openid email phone profile address https://uri.paypal.com/services/paypalhere https://api.paypal.com/v1/payments/.* https://uri.paypal.com/services/paypalattributes/business https://uri.paypal.com/services/paypalattributes';
        }
